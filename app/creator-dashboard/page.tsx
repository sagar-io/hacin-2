...
const getMockAffiliateData = (affiliateId: string): AffiliateData => ({
  ...
  experiences: [
    ...
    },
    {
      ...
      category: "Wildlife",
      image: "/placeholder.svg?height=200&width=300",
      description: "Explore the world's first nocturnal zoo and see over 2,500 animals in their natural habitat.",
    },
    {
      id: "exp-004",
      ...
      category: "Adventure",
      image: "/placeholder.svg?height=200&width=300",
      description: "Hike Mount Batur and witness a spectacular sunrise over the volcanic landscape.",
    },
    {
      id: "exp-005",
      ...
      category: "Food & Drink",
      image: "/placeholder.svg?height=200&width=300",
      description: "Discover authentic Japanese cuisine with a local guide through Tokyo's best food districts.",
    },
    {
      id: "exp-006",
      ...
      category: "Sightseeing",
      image: "/placeholder.svg?height=200&width=300",
      description: "See Paris from a different perspective on a relaxing cruise along the Seine River.",
    },
  ],
})
